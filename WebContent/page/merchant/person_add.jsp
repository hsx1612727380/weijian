...
<html>
	...
	<body>
		<form action="person_add2.html" method="post">
		...
		<table border="1px solid #555555" cellspacing="0" cellpadding="0" >
			...
			<tr>
				<td>电话</td>
				<td colspan='7'><input class="inp" type="text" name="userId"/></td>
			</tr>
			...
			<tr>
				...
				<td colspan="2"><input class="inp" type="text" name="entryTime"/></td>
				<td colspan="2">退场时间</td>
				<td colspan="2"><input class="inp" type="text" name="exitTime"/></td>
			</tr>
