...
<html>
	...
	<body>
		...
		<form action="projecttoteam.html" name="form1" method="post" class="struck">
		<div class="title">
			<div class="content">
				<span>班组求职</span>
			</div>
		...
		<div class="content personal">
			...
			<table border="0" cellspacing="1" cellpadding="0">
				...
				<tr>
					<td><a href="job_team.html?tId=${model.rId}&id=${model.id}" style="color: #4488FF;">${model.teamModel.name}</a></td>
					...
					<td><c:forEach begin="1" end="${model.teamModel.reliableStar}">
								   <span><img src="resource/images/u662.png"/></span>
								</c:forEach>
								<c:forEach begin="1" end="${model.teamModel.noreliableStar}">
								   <span><img src="resource/images/u663.fw.png"/></span>
								</c:forEach></td>
					<td>
						<div class="employ">
						<a
							href="javascript:if(confirm('确实要邀请${model.name}吗?'))location='projectapplyteam.html?tId=${model.rId}'"
