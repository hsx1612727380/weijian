...
<html>
	...
	<body>
		...
		<form action="web_material_list.html" name="form1" method="post" class="struck">
		<div class="title">
			<div class="content">
				<span>材料班组</span>
			</div>
		...
		<div class="content personal">
			...
			<table border="0" cellspacing="1" cellpadding="0">
					...
					<!-- <tr onclick='location.href="web_material_info.html?id=${model.id}"'> -->
					<tr>
						<td><a href="web_material_info.html?id=${model.id}" style="color: #4488FF;">${model.name}</a></td>
