...
<body>
	...
	<div class="content personal">
					...
					<div class="derightbottom">
						<table border="0" cellspacing="1" cellpadding="0">
							...
							<tr>
								...
								<td>${materialModel.provinceChn}${materialModel.cityChn}${materialModel.countyChn}</td>
		...
		<form class="addform" action="addSupply.html" method="post">
			<input type="hidden" name="rId" value="${materialModel.id}"/>
			<input type="hidden" name="leaderName" value="${materialModel.leaderName}"/>
			<table class="basedetail">
				<tr>
					<td class="intitle">发布材料供应信息</td>
				</tr>
				<tr>
					<td>供应商名称</td>
					<td>
						<span>
							<input  name="name" readonly type="text" value="${materialModel.name}" />
						</span>
					</td>
				</tr>
				<tr>
