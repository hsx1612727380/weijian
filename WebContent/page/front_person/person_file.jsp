	...
	<body>
		...
		<div class="content personal">
			<div class="autstate">
				...
				&nbsp;&nbsp;&nbsp;&nbsp;<font color="darkblue">诚信档案</font>
			</div>
			<div class="detail">
				<jsp:include page="person_left.jsp" flush="true" />
				<div class="detailright">
					<div class="persontitle">
						<div class="filetile">个人诚信档案</div>
				...
				<form action="updatePerson.html" method="post">
					...
					<table border="0" cellspacing="1" cellpadding="5">
						<tr>
							<th colspan="6" class="thcenter">个人资料</th>
						</tr>
						<tr>
							<th>姓名:</th>
							<td colspan="5">
								<span class="noform"><c:out value='${personModel.name}'/> </span>
							...
							<td >
								...
								<span class="form">
									<select name="marriage"  > 
										<option value="已婚" <c:if test="${personModel.marriage=='已婚'}">selected </c:if> >已婚</option>
										<option value="未婚" <c:if test="${personModel.marriage=='未婚'}">selected </c:if> >未婚</option>
									</select>
								</span>
							</td>
						</tr>
						...
						<tr>
							<th colspan="6" class="thcenter">进/出场时间</th>
						</tr>
						<tr>
							<th>进场时间: </th>
							<td colspan="2" >
						...
						<tr>
							<th class="thcenter" colspan="6">技能</th>
						</tr>
						<tr>
							<th>技能类别:</th>
							<td>
								...
								<span class="form" >
									<select id="skillBigType" onchange="skillBigType1()" name="skillBigType" style="width: 96px"> 
										<option value="${personModel.skillBigType}" >技能大类</option>
							...
							<td colspan="1">
								...
								<span class="form">
									<select  name="skillSmallType" id="smalltype">
										<%-- <option selected="selected" value="${personModel.skillSmallType}">${personModel.skillSmallTypeName}</option> --%>
									</select>
								</span>
							</td>
							<th>工作年限:</th>
					...
					<table  class="hide" class="assess" border="0" cellspacing="1" cellpadding="0">
						<tr>
							<td>项目名称</td>
							<td>起止时间</td>
							<td>所在班组</td>
