...
<html>
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="<%=basePath%>/resource/css/front_company/identerprise.css" />
		<link rel="stylesheet" type="text/css" href="<%=basePath%>/resource/css/front_company/projectdetail.css" />
	...
	<body>
		...
		<div class="content personal">
			<div class="operate clearfix">
				<a class="cancel" href="compamy_projectProgress.html?id=${projectModel.id }">项目进度</a>
				<a class="cancel" href="company_projectChart.html?pId=${projectModel.id}">统计报表</a>
			</div>
			
			<form action="company_modfiyProject2.html" method="post">
				...
				<div class="column">
					...
					<table class="basedetail" border="0" cellspacing="1" cellpadding="0">
						<tr>
							...
							<td>
								<span class="baseedits">${projectModel.pCode }</span>
								<input id="pCode" class="baseeditinput" type="text" name="pCode" value="${projectModel.pCode }"/>
							</td>
						...
						<tr>
							...
							<td>
								<span class="baseedits">${projectModel.province}${projectModel.city}</span>
						...
						<tr>
							...
							<td>
								<span class="baseedits ">${projectModel.allWork}</span>
								<input id="allWork" class="baseeditinput" type="text" name="allWork" value="${projectModel.allWork}"/>
							</td>
							<th><span class="red">*</span>本次工程量</th>
							<td>
								<span class="baseedits ">${projectModel.thsWork}</span>
								<input id="thsWork" class="baseeditinput" type="text" name="thsWork" value="${projectModel.thsWork}"/>
							</td>
							<th><span class="red">*</span>累计工程量</th>
							<td>
								<span class="baseedits ">${projectModel.accWork}</span>
								<input id="accWork" class="baseeditinput" type="text" name="accWork" value="${projectModel.accWork}"/>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<th>工程状态</th>
							<td>
								<span class="baseedits ">${projectModel.status}</span>
							...
							<th>累计完成比例</th>
							<td><!-- <span class="precent">100%</span> -->
						...
						<tr>
							<th>单位</th>
							<td>
								<span class="baseedits ">${projectModel.unit}</span>
								<input class="baseeditinput" type="text" name="unit" value="${projectModel.unit}"/>
							</td>
						</tr>
					</table>
				</div>
				<div>
					<!-- <label>经度</label> -->
					<input id="lonlat" name="lonlat" type="hidden" value="${projectModel.longitude }">
				</div>
				<div>
					<!-- <label>纬度</label> -->
					<input id="lonlat2" name="lonlat2" type="hidden" value="${projectModel.latitude }">
				</div>
			...
			<form action="company_addOrModfiyProject2.html" method="post">
				<input type="hidden" name="code" value="${projectModel.code }"/>
				<input type="hidden" name="id" value="${projectModel.id }"/>
				<div class="column">
					<div class="intitle">
			...
			<div class="column">
				...
				<table class="basedetail">
					<c:forEach items="${joinBuildModels }" var="joinBuildModel">
						<form action="company_modfiyBuildUnit.html" method="post">
							<input type="hidden" name="pCode" value="${projectModel.pCode }"/>
							<tr>
								<!-- <th>建设单位</th> -->
								<td><input id="joinBuildId" type="hidden" name="id" value="${joinBuildModel.id }"></td>
								<td>企业名称:</td>
								<td>
			...
			<div class="column">
				...
				<table class="basedetail keymen">
					<c:forEach items="${keyPersonModels }" var="keyPersonModel">
						<form action="company_modfiyStaffPosition.html" method="post">
							<input type="hidden" name="pCode" value="${projectModel.pCode }"/>
							<tr>
								<td><input id="keyPersonId" type="hidden" name="id" value="${keyPersonModel.id }"></td>
								<td>姓名:</td>
								<td>
			...
			<form action="company_modfiyProjectNote.html" method="post">
				<input type="hidden" name="pCode" value="${projectModel.pCode }"/>
				<div class="columntwo">
					...
					<%-- <input class="baseeditinput" type="text"  style="width: auto;"  name="note" value="${projectModel.note }"/> --%>
				</div>
				<div class="columnthree">
			...
			<!-- hidden -->
			<form class="addform" id="joinBuild" action="company_addBuildUnit.html" method="post">
				<input type="hidden" name="pCode" value="${projectModel.pCode }"/>
				<input type="hidden" name="id" value="${projectModel.id }"/>
				<table class="basedetail">
					<tr>
			...
			<form class="addform" id="keyPerson" action="company_addStaffPosition.html" method="post">
				<input type="hidden" name="pCode" value="${projectModel.pCode }"/>
				<input type="hidden" name="id" value="${projectModel.id }"/>
				<table class="basedetail">
					<tr>
		...
		<script src="<%=basePath%>/resource/js/front_company/companyDetailProject.js" type="text/javascript" charset="utf-8"></script>
		<script src="<%=basePath%>/resource/js/front_company/projectdetail.js" type="text/javascript" charset="utf-8"></script>
		<script src="<%=basePath%>/resource/js/front_company/joinBuild.js" type="text/javascript" charset="utf-8"></script>
		<script src="<%=basePath%>/resource/js/front_company/keyPerson.js" type="text/javascript" charset="utf-8"></script>
	</body>
