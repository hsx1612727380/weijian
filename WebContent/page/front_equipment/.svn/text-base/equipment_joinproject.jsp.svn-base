...
<html>
	...
	<head>
		...
		<script type="text/javascript">
			...
			$(function(){
				var vid = '${equipmentModel.id}';//班组id
				var name = '${equipmentModel.name}';//班组名称
				...
				$(".joinProject").on('click',function(){
					...
					if(name==null&&name==""){
						...
						$.ajax({
							...
							type : "POST",
							data : {vId : vid, pId : pid, status : status, type : 3, name : name,pdId : pdId},
							dataType : 'text',
							async : true,
							success : function(msg){
								alert(msg);
								//撤回操作需要刷新页面
								document.location.href = "equipmentJoinProject.html";
							},
							error:function(){
								alert("数据加载失败！");
							}
			...
			<div class="detail">
				...
				<div class="detailright">
					...
					<div class="derighttop">
						<form id="form" action="equipmentJoinProject.html" method="post">
					...
					<table class="addground" border="0" cellspacing="1" cellpadding="0">
						...
						<div class="tabfooter">
							<form action="equipmentJoinProject.html" method="post">
								<div class="footerl">
									<span>每页：</span>
