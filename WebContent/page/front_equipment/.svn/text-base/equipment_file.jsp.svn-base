			...
			<div class="detail">
				...
				<div class="detailright">
					<div class="persontitle">
						<div class="filetile">设备供应商诚信档案</div>
				...
				<form action="updateMerchant.html" method="post">
					...
					<table border="0" cellspacing="1" cellpadding="5">
						...
						<tr>
							...
							<th>成立日期:</th>
							<td>
								<span class="noform">${merchantModel.build}</span>
						...
						<tr>
							<th>注册资金（万）:</th>
							<td>
								<span class="noform">${merchantModel.registercapital}</span><!-- class="noform" -->
								<span class="form" ><input name="registercapital" type="text" value="${merchantModel.registercapital}"/></span>
							</td>
							<th>实缴（万）:</th>
							<td>
