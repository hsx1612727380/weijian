...
<html>
	...
	<body>
<form action="recruit_equip_list.html" method="post">
				<div class='search clearfix'>
					<h3>招聘</h3>
					<span class="datum">招聘>>设备租赁</span>
					...
					<table border="0px" cellspacing="0px" cellpadding="0px">
						...
						<tr>
							...
							<td><label for="uid">设备名称:</label></td>
				...
				<div class="ifamelayout">
						<span class="items"><a href="recruit_equip_add.html">添加</a></span>
						...
						<tr>
							...
							<td>
								<span class="add">
									...
									<a href="javascript:if(confirm('确实要关闭${model.title}吗?'))location='recruit_equip_close.html?id=${model.id}&status=0'" style="color:white">关闭</a>
									</c:if>
									<c:if test="${model.status=='0'}">
									<a href="javascript:if(confirm('确实要开启${model.title}吗?'))location='recruit_equip_close.html?id=${model.id}&status=1'" style="color:white">开启</a>
									</c:if>
								</span>
								<span class="del">
									<a href="javascript:if(confirm('确实要删除${model.title}吗?'))location='recruit_equip_del.html?id=${model.id}'" style="color:white">删除</a>
								</span>
							</td>
						</tr>
					</c:forEach> 
