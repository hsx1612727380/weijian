...
<html>
	...
	<body>
<form action="recruit_person_list.html" method="post">
				<div class='search clearfix'>
					<h3>招聘</h3>
					<span class="datum">招聘>>招聘个人</span>
				...
				<div class="ifamelayout">
						<span class="items"><a href="recruit_person_add.html">添加</a></span>
						...
						<tr>
							...
							<td>
								<span class="add">
									...
									<a href="javascript:if(confirm('确实要关闭${tmodel.title}吗?'))location='recruit_person_close.html?id=${tmodel.id}&status=0'" style="color:white">关闭</a>
									</c:if>
									<c:if test="${tmodel.status=='0'}">
									<a href="javascript:if(confirm('确实要开启${tmodel.title}吗?'))location='recruit_person_close.html?id=${tmodel.id}&status=1'" style="color:white">开启</a>
									</c:if>
								</span>
								<span class="del">
									<a href="javascript:if(confirm('确实要删除${tmodel.title}吗?'))location='recruit_person_del.html?id=${tmodel.id}'" style="color:white">删除</a>
								</span>
							</td>
						</tr>
					</c:forEach> 
