...
<title>新增供需信息</title>
	...
	<form action="recruit_person_add2.html" method="post">
				...
				<tr>
					...
					<tr>
						<td><label for="name">招聘人数:</label></td>
						<td><input class="val" type="text" name="num" />*请填数字</td>
					</tr>
