...
<html>
	...
	<body>
<form action="job_equip_list.html" method="post">
				<div class='search clearfix'>
					...
					<table border="0px" cellspacing="0px" cellpadding="0px">
						<tr>
							...
							<td><label for="code">设备名称:</label></td>
				...
				<div class="ifamelayout">
						<span class="items"><a href="job_equip_add.html">添加</a></span>
					...
					<table class="querytable" border="1px" cellspacing="0" cellpadding="3px" style="text-align: center;">
						...
						<tr>
							<td>${tmodel.title}&nbsp;&nbsp;</td>
							<td>${tmodel.equipmentModel.name}&nbsp;&nbsp;</td>
							<td>${tmodel.shopName}&nbsp;&nbsp;</td>
							<td>${tmodel.equipmentModel.userId}&nbsp;&nbsp;</td>
							...
							<td>
								<span class="add">
									...
									<a href="javascript:if(confirm('确实要关闭${tmodel.title}吗?'))location='job_equip_close.html?id=${tmodel.id}&status=0'" style="color:white">关闭</a>
									</c:if>
									<c:if test="${tmodel.status=='0'}">
									<a href="javascript:if(confirm('确实要开启${tmodel.title}吗?'))location='job_equip_close.html?id=${tmodel.id}&status=1'" style="color:white">开启</a>
									</c:if>
								</span>
								<span class="del">
									<a href="javascript:if(confirm('确实要删除${tmodel.title}吗?'))location='job_equip_del.html?id=${tmodel.id}'" style="color:white">删除</a>
								</span>
							</td>
						</tr>
					</c:forEach> 
