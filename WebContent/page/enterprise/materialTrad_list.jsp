...
<html>
	...
	<body>
				...
				<div class='search clearfix'>
					<h3>材料商管理</h3>
					<span class="datum">材料商管理>>材料商出入库记录</span>
					<form name="reg_testdate" action="materialTrad_list2.html" method="post">
					<table border="0px" cellspacing="0px" cellpadding="0px">
						<tr>
							<td><label for="eName">材料商名称:</label></td>
