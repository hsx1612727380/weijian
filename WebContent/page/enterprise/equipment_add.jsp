...
<title>新增设备商</title>
	...
	<body>
	<form action="equipment_add2.html" method="post">
				<div class='search clearfix'>
					<h3>设备商管理</h3>
					<span class="datum">设备商管理>>新增设备商</span>
					<table border="0" cellspacing="0" cellpadding="0" style="display:table;margin:0 auto;">
					<tr>
						<td><label for="uid">设备商代码:</label></td>
						<td style="color:red"><input id="Code" class="inp" type="text" name="code" placeholder="请输入设备商代码"/><span>*必须填写</span></td>
					</tr>
					<tr>
						<td><label for="uid">设备商名称:</label></td>
						<td style="color:red"><input id="Name" class="inp" type="text" name="name" placeholder="请输入设备商名称"/><span>*必须填写</span></td>
					</tr>
					<tr>
	...
	<script src="resource/js/equipment_add_check.js" type="text/javascript" charset="utf-8"></script>
