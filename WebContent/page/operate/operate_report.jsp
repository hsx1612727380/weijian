...
<html>
	...
	<head>
		...
		<script type="text/javascript">
			...
			function submitOperateReportForm() {
	...
	<body>
		...
		<div class="content personal">
			...
			<form id="myform" action="operate_getReport.html?projectId=${projectModel.id }&flag=0&result=0" method="POST">
				<table class="condition" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td style="text-align: right;">
							<div id="search" onclick="return submitOperateReportForm();">查询</div>
						</td>
						<td></td>
					</tr>
				</table>
				...
				<table class="chart" border="0" cellspacing="1" cellpadding="0">
					...
					<tr>
						...
						<td style="text-align: left;" colspan="16">
							<span class="items">
								&nbsp;&nbsp;<div><a href="operate_reportTeamList.html?year=${year}&month=${month}&projectId=${projectId}&type=1&result=0" style="color: white;">人工费</a></div>
							</span>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td></td>
						<%-- <td>${cmdSummTotalEmployeeModel.unit}</td> --%>
						...
						<%-- <td>${cmdSummTotalEmployeeModel.settlement}</td>
						<td>${cmdSummTotalEmployeeModel.note}</td> --%>
						<td></td>
						<td></td>
					</tr>
					<tr>
						...
						<td style="text-align: left;" colspan="15">
							<span class="items">
								&nbsp;&nbsp;<div><a href="operate_reportMaterialList.html?year=${year}&month=${month}&projectId=${projectId}&type=2&result=0" style="color:white;">材料费</a></div>
							</span>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<%-- <td>${cmdSummTotalMaterialModel.unit}</td> --%>
						<td></td>
						...
						<%-- <td>${cmdSummTotalMaterialModel.settlement}</td>
						<td>${cmdSummTotalMaterialModel.note}</td> --%>
						<td></td>
						<td></td>
					</tr>
					<tr>
						...
						<td style="text-align: left;" colspan="15">
							<span class="items">
								&nbsp;&nbsp;<div><a href="operate_reportEquipmentList.html?year=${year}&month=${month}&projectId=${projectId}&type=3&result=0" style="color:white;">设备费</a></div>
							</span>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<%-- <td>${cmdSummTotalEquipmentModel.unit}</td> --%>
						<td></td>
						...
						<%-- <td>${cmdSummTotalEquipmentModel.settlement}</td>
						<td>${cmdSummTotalEquipmentModel.note}</td> --%>
						<td></td>
						<td></td>
					</tr>
				</table>
			...
			<div class="chartboxtwo" data-flag=${flag }>
				<div class="chartadd"><a href="operate_posterProjectAdd.html?projectId=${projectModel.id }&flag=${flag }" style="color: white;">新增</a></div>
				<a class='chartadd' href="operate_posterProjectDownloadExcel.html" style="color: white; width: 100px;">EXCEL模板下载</a>
				<form action="operate_posterProjectImportExcel.html?projectId=${projectModel.id }&flag=${flag }" method="post" enctype="multipart/form-data" style='display:inline-block'>
				...
				<form action="operate_getReport.html?projectId=${projectModel.id }&flag=${flag }&result=${result}" method="post">
					<div class="tabfooter">
						<div class="footerl">
							<span>每页：</span>
			...
			<div class="chartboxthree" data-flag=${flag }>
				<div class="chartadd"><a href="operate_posterUserAdd.html?projectId=${projectModel.id }&flag=${flag }" style="color: white;">新增</a></div>
				<a class='chartadd' href="operate_posterUserDownloadExcel.html" style="color: white; width: 100px;">EXCEL模板下载</a>
				<form action="operate_posterUserImportExcel.html?projectId=${projectModel.id }&flag=${flag }" method="post" enctype="multipart/form-data" style='display:inline-block'>
					<i class="chartadd" style='position:relative;margin-right:3px'>
						导入Execl
				...
				<table class="chart" border="0" cellspacing="1" cellpadding="0">
					...
					<c:forEach items="${showUserTeamRosterVos }" var="showUserTeamRosterVo" varStatus="status">
						<tr>
							...
							<%-- <td>${showUserTeamRosterVo.userModel.userProvinceStr }${showUserTeamRosterVo.userModel.userCityStr }${showUserTeamRosterVo.userModel.userStreet }</td> --%>
							<td>${showUserTeamRosterVo.userModel.userStreet }</td>
			...
			<div class="chartboxfour" data-flag=${flag }>
				<div class="chartadd"><a href="operate_posterMEAdd.html?projectId=${projectModel.id }&flag=${flag }" style="color: white;">新增</a></div>
				<a class="chartadd" href="operate_posterMEDownloadExcel.html" style="color: white; width: 100px;">EXCEL模板下载</a>
				<form action="operate_posterMEImportExcel.html?projectId=${projectModel.id }&flag=${flag }" method="post" enctype="multipart/form-data" style='display:inline-block'>
					<i class="chartadd" style='position:relative;margin-right:3px'>
						导入Execl
				...
				<table class="chart" border="0" cellspacing="1" cellpadding="0">
					<tr>
						<th colspan="6">供应商花名册</th>
					</tr>
					<tr>
						<td>项目名称:</td>
						<td colspan="5">${projectModel.name }</td>
					</tr>
					<tr>
						<td>序号</td>
						<td>供应商名称</td>
					...
					<c:forEach items="${showMERosterVos }" var="showMERosterVo" varStatus="status">
						<tr>
							...
							<c:if test="${showMERosterVo.type == 2 }">
								...
								<td>${showMERosterVo.materialModel.shopName }</td>
								<td>${showMERosterVo.materialModel.street }</td>
							...
							<c:if test="${showMERosterVo.type == 3 }">
								...
								<td>${showMERosterVo.equipmentModel.shopName }</td>
								<td>${showMERosterVo.equipmentModel.street }</td>
		...
		<script src="<%=basePath%>/resource/js/operate/projectchart.js" type="text/javascript" charset="utf-8"></script>
	</body>
