...
<html>
	...
	<body>
		...
		<div class="content personal">
			...
			<div class="detail">
				<div class="detailright">
					<form action="operate_reportTeamAdd2.html" method="post">
						...
						<div>
							...
							<span id="teamAndSummRepCHeck"><input id="teamCode" type="text" name="teamCode" placeholder="必填"/></span>
						</div>
						<div>
						...
						<div>
							<label>已付工资</label>
							<span><input type="text" name="thisSalary"/></span>
							<label>未付工资</label>
						...
						<input id="addReportTeamSubmit" type="submit" class="identy" value="添加" /> 
		...
		<script src="<%=basePath%>/resource/js/operate/reportTeamAdd.js" type="text/javascript" charset="utf-8"></script>
	</body>
