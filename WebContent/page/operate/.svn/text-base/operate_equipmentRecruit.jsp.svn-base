...
<html>
	...
	<body>
		...
		<div class="content personal">
			...
			<div class="detail">
				<div class="detailright">
					<form action="operate_equipmentRecruit2.html" method="post">
						...
						<input id="equipmentRecruitAddSubmit" type="submit" class="identy" value="保存" />
		...
		<script src="<%=basePath%>/resource/js/operate/equipmentRecruit.js" type="text/javascript" charset="utf-8"></script>
	</body>
