...
<body>
	<form action="aptitude_modify2.html" method="post">
		<div class='search clearfix'>
			<h3>公司管理</h3>
			<span class="datum">公司管理>>修改公司资质与资信的信息</span>
			<table border="0" cellspacing="0" cellpadding="0"
				style="display: table; margin: 0 auto;">
				<tr>
					<td><label for="name">证书编号:</label></td>
					<td><input class="inp" type="text" name="certificate"
						value="${model.certificate}" /></td>
				</tr>
				<tr>
				...
				<tr>
					<td><label for="gender">审批机关:</label></td>
					<td><input class="inp" type="text" name="approval"
						value="${model.approval}" /></td>
				</tr>
				<tr>
					<td><label for="gender">资质最新批准日期:</label></td>
					<td><input class="inp" type="text" name="approvalTime"
						value="${model.approvalTime}" /></td>
				</tr>
				<tr>
					<td><label for="gender">资质有效期:</label></td>
					<td><input class="inp" type="text" name="validity"
						value="${model.validity}" /></td>
				</tr>
